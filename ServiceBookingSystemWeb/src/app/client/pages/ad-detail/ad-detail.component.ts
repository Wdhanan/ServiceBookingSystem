...
export class AdDetailComponent implements OnInit {
  ...
  // set the "adId" we are using in the Client-routing module
  adId= this.activatedroute.snapshot.params['adId'];
  avatarUrl: any;
  ad: any;
  reviews:any;

  // create a reactive form to take the input from the User
  validateForm! :FormGroup;
  constructor(private clientService: ClientService,
    private activatedroute: ActivatedRoute, // to get the id from the url
...
this.validateForm = this.fb.group({
  ...
  bookService(){
    // prepare the DTO as json Object
